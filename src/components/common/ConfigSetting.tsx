...
export const ConfigSetting: React.FC = () => {
  ...
  const handleCopyConfig = () => {
    ...
    showToast({
      type: "success",
      title: t("configSetting.copiedTitle"),
      message: t("configSetting.copiedMessage"),
      timeout: 3000,
    });
  };
      ...
      >
          ...
          <div className="px-6 py-6 space-y-6">
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-primary">
                {t("configSetting.tab.general")}
              </h3>

              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.language")}
                </span>
                <Select
              ...
              {settings.watermark && (
                <div className="space-y-1.5 pl-2 border-l-2 border-primary animate-in fade-in duration-200">
                  ...
                  <Input
                    ...
                    placeholder={t("configSetting.placeholderWatermark")}
                  />
                </div>
              )}
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-primary">
                {t("configSetting.tab.interface")}
              </h3>

              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.theme")}
                </span>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="light">
                      {t("configSetting.themeLight")}
                    </SelectItem>
                    <SelectItem value="dark">
                      {t("configSetting.themeDark")}
                    </SelectItem>
                    <SelectItem value="system">
                      {t("configSetting.themeSystem")}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
                ...
                <div className="grid grid-cols-5 gap-3">
                  {primaryColors.map((color) => (
                    <button
                      ...
                      title={t("configSetting.color." + color.name)}
                    >
                      {settings.primaryColor === color.value && (
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="solid">
                        {t("configSetting.solidColor")}
                      </SelectItem>
                      <SelectItem value="gradient">
                        {t("configSetting.gradientColor")}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-primary">
                {t("configSetting.tab.layout")}
              </h3>

              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.layoutMode")}
                </span>
                <Select
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.sidebarPosition")}
                </span>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="left">
                      {t("configSetting.positionLeft")}
                    </SelectItem>
                    <SelectItem value="right">
                      {t("configSetting.positionRight")}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.configPosition")}
                </span>
                <Select
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-primary">
                {t("configSetting.tab.sidebar")}
              </h3>

              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.showSidebar")}
                </span>
                <Switch
                  size="sm"
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.collapseSidebar")}
                </span>
                <Switch
                  size="sm"
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  <span className="font-medium">
                    {t("configSetting.sidebarCollapsedWidth")}
                  </span>
                  <span className="text-muted-foreground">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-primary">
                {t("configSetting.tab.tabs")}
              </h3>

              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.showTabs")}
                </span>
                <Switch
                  size="sm"
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.showMaximizeTab")}
                </span>
                <Switch
                  size="sm"
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="chrome">
                      {t("configSetting.tabStyleChrome")}
                    </SelectItem>
                    <SelectItem value="card">
                      {t("configSetting.tabStyleCard")}
                    </SelectItem>
                    <SelectItem value="icon">
                      {t("configSetting.tabStyleIcon")}
                    </SelectItem>
                    <SelectItem value="simple">
                      {t("configSetting.tabStyleSimple")}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-primary">
                {t("configSetting.tab.effects")}
              </h3>

              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.pageProgress")}
                </span>
                <Switch
                  size="sm"
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.pageTransition")}
                </span>
                <Switch
                  size="sm"
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.transitionEffect")}
                </span>
                <Select
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-bold text-primary">
                {t("configSetting.tab.footer")}
              </h3>

              <div className="flex items-center justify-between">
                <span className="text-xs font-medium">
                  {t("configSetting.showFooter")}
                </span>
                <Switch
                  size="sm"
              ...
              <div className="space-y-1">
                <span className="text-[10px] text-muted-foreground">
                  {t("configSetting.companyWebsite")}
                </span>
                <Input
                  className="h-8 text-xs"
        ...
        <div className="p-4 border-t border-border bg-muted/20 space-y-2 mt-auto shrink-0">
          ...
          >
            ...
            {t("configSetting.clearCacheLogout")}
          </Button>
        </div>
      </SheetContent>
    </Sheet>
