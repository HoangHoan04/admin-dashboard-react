...
export default function ServerError({
  ...
  const $t = {
    title: t("error.500Title"),
    desc: t("error.500Desc"),
    goBack: t("error.goBack"),
    tryAgain: t("error.tryAgain"),
    retrying: t("error.retrying"),
    goHome: t("error.goHome"),
    help: t("error.help"),
    autoRetryOn: (s: number) => t("error.autoRetryOn", { s }),
    cancelAutoRetry: t("error.cancelAutoRetry"),
    copyDetails: t("error.copyDetails"),
    copied: t("error.copied"),
    report: t("error.reportIssue"),
    online: t("error.online"),
    offline: t("error.offline"),
    occurredAt: t("error.occurredAt"),
    agoSuffix: t("error.agoSuffix"),
  };
