...
export default function ComingSoon({
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.7)), url(${backgroundImageUrl || "/path-to-your-mountain-image.jpg"})`,
      }}
    >
      ...
      <main className="relative z-10 grid grid-cols-1 lg:grid-cols-[1.2fr_auto_1fr] items-center gap-8 lg:gap-16 my-auto max-w-6xl w-full mx-auto pt-12 pb-8">
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3 py-1">
            ...
            <CountdownUnit value={seconds} label={t("comingSoon.seconds")} />
          </div>
